...
public static class Utils
{
    ...
    public static bool GetCharCount(this string input, out int enChar, out int cnChar)
    {
        enChar = 0;
        cnChar = 0;
        foreach (var c in input)
    ...
    private static readonly Dictionary<string, string[]> LanguageDatas = new()
    {
        ...
        ["menu_reset_reminder"] = ["Reset Reminder Times", "重置提醒次数"],
        ["menu_project_page"] = ["Project Page", "项目主页"],
        ["btn_close"] = ["Close", "关闭"],
        ["col_code"] = ["Code", "代码"],
        ["col_name"] = ["Name", "名称"],
        ...
        ["col_ReminderPriceUp"] = ["ReminderPriceUp", "大于"],
        ["col_ReminderPriceDown"] = ["ReminderPriceDown", "小于"],
        ["col_ReminderTimes"] = ["ReminderTimes", "剩余提醒次数"],
